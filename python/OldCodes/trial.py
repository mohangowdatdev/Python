...
def engname():
    return print("My pleasured engineers name is Mohan Gowda and Sanketh Bharadwaj \n I even have a senior chief engineer do you want to know?")
def hero():
...
print("\n My Name is Rocky")
time.sleep(2)
print("\n I am an AI bot who is designed by my engineers Mohan Gowda and Sanketh Bharadwaj")
time.sleep(3)
